...
RSpec.describe 'Admin Application Show Page' do
  before :each do
    @happy_tails = Shelter.create!(name: "@ppy Tails", foster_program: true, city: "San Francisco", rank: 3)
  ...
  describe "Rejecting Pet for Adoption" do
    it "Updates a pet's status to rejected and removes the reject/approve buttons" do 
  ...
  describe "Accepting Pet for Adoption" do
    it "Updates a pet's status to accepted and removes the reject/approve buttons" do
      visit "/admin/applications/#{@phylis.id}"
